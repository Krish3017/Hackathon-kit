    ...
    <Card className="card-animate w-full max-w-sm border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60 shadow-2xl">
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="px-5 py-0 grid gap-3">
          ...
          {/* Side-by-side password inputs to reduce card height */}
          ...
          <Button type="submit" className="w-full h-8.5 rounded-lg bg-zinc-50 text-zinc-900 hover:bg-zinc-200 text-xs font-medium transition-colors">
            Create account
          </Button>
